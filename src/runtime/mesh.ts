...
function maxPayloadBytes(type: string): number {
  ...
  if (type === 'projectUpdate' || type === 'stateDocument' || type === 'stateDiff'
    || type === 'textEditIntent' || type === 'textEditAccepted'
    || type === 'textEditRejected' || type === 'textStateSnapshot') return 64 * 1024 * 1024;
  return 4 * 1024 * 1024;
}
